        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="page-heading">
                    <h1>Напишите нам, если у Вас появились проблемы при использованние данного сервиса</h1>
                    <span class="subheading">и мы постараеимся ответить как можно скорее</span>
                </div>
            </div>
        </div>
    </div>
